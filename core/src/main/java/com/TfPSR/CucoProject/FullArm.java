...
public class FullArm {
    ...
    public FullArm(Vector2 position, Vector2 size, float angle, BodyDef.BodyType type, World world, float density, float friction, float restitution) {
        ...
        arm = ShapeFactory.createRectangle(armPosition, armSize, angle, type, world, density, friction, restitution);
        forearm = ShapeFactory.createRectangle(forearmPosition, forearmSize, angle, type, world, density, friction, restitution);
        hand = ShapeFactory.createRectangle(handPosition, handSize, angle, type, world, density, friction, restitution);
    }
